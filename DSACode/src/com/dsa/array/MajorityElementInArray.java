...
/*
 * Majority Number Asked In: Yahoo Linkedin
 */
/*
 * Given an array of integer, write an efficient algorithm to find majority
 * number in that array in Time Complexity O(n) and Space Complexity O(1)
 * Example:
 * 
 * [Majority Number : The only number in the integer array which appears more
 * than n/2 times if the length of the array is n] Input : [1, 8, 7, 4, 1, 2, 2,
 * 2, 2, 2, 2 ] Output: 2 ( 2 appears in this integer array more than 5 times]
 * [Hint: Think of using the hint, element appears more than half Problem level:
 * Medium
 */